defmodule Jarga.Chat.Infrastructure.Schemas.MessageSchema do
  @moduledoc """
  ...
  For the pure domain entity, see Jarga.Chat.Domain.Entities.Message.
  """
  ...
  schema "chat_messages" do
    ...
    belongs_to(:chat_session, Jarga.Chat.Infrastructure.Schemas.SessionSchema)
