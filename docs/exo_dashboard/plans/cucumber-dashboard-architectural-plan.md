...
- [x] ✓ **RED**: Write test `apps/perme8_tools/test/mix/tasks/exo_test_test.exs`
...
- [x] ✓ **GREEN**: Update `Mix.Tasks.ExoTest.build_cmd_args/5` to accept optional `message_output` path
  - When provided, append `--format`, `message:#{message_output}` to the bun args
- [x] ✓ **REFACTOR**: Extract common arg-building logic

### Phase 0 Validation
- [x] ✓ All TypeScript tests pass (`bun test` in `tools/exo-bdd/`)
- [x] ✓ All Elixir tests pass for `perme8_tools` (`mix test` in `apps/perme8_tools/`)
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/domain/entities/feature_test.exs`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/domain/entities/feature.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/domain/entities/scenario_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/domain/entities/scenario.ex`
  - Pure struct: `[:id, :name, :keyword, :description, :tags, :steps, :examples, :location]`
- [x] ✓ **REFACTOR**: Clean up

### 1.3: Step Entity (Pure Struct)

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/domain/entities/step_test.exs`
  - Tests: `Step.new/1` creates struct with id, keyword, keyword_type, text, location, data_table, doc_string
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/domain/entities/step.ex`
  - Pure struct: `[:id, :keyword, :keyword_type, :text, :location, :data_table, :doc_string]`
- [x] ✓ **REFACTOR**: Clean up

### 1.4: Rule Entity (Pure Struct)

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/domain/entities/rule_test.exs`
  - Tests: `Rule.new/1` creates struct with id, name, description, tags, children (scenarios)
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/domain/entities/rule.ex`
  - Pure struct: `[:id, :name, :description, :tags, :children]`
- [x] ✓ **REFACTOR**: Clean up

### 1.5: AdapterClassifier Policy

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/domain/policies/adapter_classifier_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/domain/policies/adapter_classifier.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/domain/entities/test_run_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/domain/entities/test_run.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/domain/entities/test_case_result_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/domain/entities/test_case_result.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/domain/entities/test_step_result_test.exs`
  - Tests: `TestStepResult.new/1` creates struct with test_step_id, status, duration, error_message, exception
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/domain/entities/test_step_result.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/domain/policies/status_policy_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/domain/policies/status_policy.ex`
- [x] ✓ **REFACTOR**: Clean up

### 1.10: ResultMatcher Policy

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/domain/policies/result_matcher_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/domain/policies/result_matcher.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/application/use_cases/process_envelope_test.exs`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/application/use_cases/process_envelope.ex`
...
- [x] ✓ **REFACTOR**: Clean up, extract envelope key matching into helpers

### 1.12: DiscoverFeatures Use Case

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/application/use_cases/discover_features_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/application/use_cases/discover_features.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/application/use_cases/start_test_run_test.exs`
  ...
  - Use `ExUnit.Case, async: true`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/application/use_cases/start_test_run.ex`
...
- [x] ✓ All application use case tests pass with mocks
- [x] ✓ No boundary violations (app has no boundary config yet -- standalone, no cross-app deps)
...
- [x] ✓ Create new Phoenix app: `mix phx.new exo_dashboard --no-ecto --no-mailer --no-dashboard` in `apps/`
...
- [x] ✓ Create `apps/exo_dashboard/assets/` directory structure:
...
- [x] ✓ Verify: `mix assets.build` compiles CSS and JS without errors

### 2.3: Gherkin Parser Node Script

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/infrastructure/gherkin_parser_test.exs`
...
- [x] ✓ **GREEN**: Implement Gherkin parser in two parts:
  1. **Node script**: `apps/exo_dashboard/priv/gherkin_parser/parse.mjs`
     - Reads feature file path from CLI argument
     - Uses `@cucumber/gherkin` and `@cucumber/messages`
  ...
  2. **Elixir wrapper**: `apps/exo_dashboard/lib/exo_dashboard/features/infrastructure/gherkin_parser.ex`
     - Calls `bun run parse.mjs <file_path>` via `System.cmd`
     - Collects JSON output
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/features/infrastructure/feature_file_scanner_test.exs`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features/infrastructure/feature_file_scanner.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/infrastructure/result_store_test.exs`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/infrastructure/result_store.ex`
...
- [x] ✓ **REFACTOR**: Consider using `:ets.new` with `:named_table` for direct access

### 2.6: RunExecutor (Process Spawner)

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/infrastructure/run_executor_test.exs`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/infrastructure/run_executor.ex`
  - `start(run_id, opts)` spawns a Task that:
    1. Determines config path from scope
    2. Creates temp NDJSON output path
    3. Builds bun command args
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/test_runs/infrastructure/ndjson_watcher_test.exs`
  ...
  - Tests: Each parsed envelope is passed to callback
  ...
  - Use `ExUnit.Case, async: false` (file I/O)
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs/infrastructure/ndjson_watcher.ex`
  - GenServer that:
    1. Polls the NDJSON file at configurable intervals
    2. Tracks byte offset (reads only new content since last poll)
    3. Splits new content into lines, parses each as JSON
    4. Invokes callback for each envelope
    5. Stops polling after `testRunFinished`
- [x] ✓ **REFACTOR**: Clean up

### 2.8: Features Context Facade

- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/features.ex`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard/test_runs.ex`
  - Public API: `get_run/1`, `list_runs/0`, `get_results/1`
  - Delegates to ResultStore
  - `use Boundary` config
- [x] ✓ **REFACTOR**: Clean up

### 2.10: ExoDashboardWeb Module + Endpoint + Router

- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web.ex`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/endpoint.ex`
...
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/router.ex`
  - Single browser pipeline (no auth)
  - Routes: `live "/", DashboardLive` and `live "/features/*uri", FeatureDetailLive`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/components/layouts.ex`
  - Root layout: HTML skeleton with Tailwind CSS, app.js
  - App layout: Dashboard shell with sidebar/header
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/components/core_components.ex`
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard_web/live/dashboard_live_test.exs`
  ...
  - Tests: Refresh re-discovers features from disk
  - Use `ExoDashboardWeb.ConnCase`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/live/dashboard_live.ex` + `.html.heex`
  - `mount/3`:
    - Call test catalog or `ExoDashboard.Features.discover/0` to load catalog
...
- [x] ✓ **REFACTOR**: Extract feature tree rendering into FeatureComponents

### 2.12: FeatureDetailLive (Single Feature View)

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard_web/live/feature_detail_live_test.exs`
  - Tests: `GET /features/*uri` renders the feature detail page
  - Tests: Shows feature name and description
  - Tests: Lists all scenarios with their steps
  - Tests: Shows Rules as sections containing their scenarios
  - Tests: Shows back link to dashboard
  - Use `ExoDashboardWeb.ConnCase`
- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/live/feature_detail_live.ex` + `.html.heex`
  - `mount/3`:
    - Parse URI param, find feature in catalog
    - Assign: feature, results, active_run
  - Renders: Feature header, scenario list, step detail
- [x] ✓ **REFACTOR**: Clean up

### 2.13: Feature Components

- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/components/feature_components.ex`
  - Function components: `feature_card/1`, `scenario_row/1`, `adapter_badge/1`, `app_group/1`
- [x] ✓ **REFACTOR**: Clean up

### 2.14: Result Components

- [x] ✓ **GREEN**: Implement `apps/exo_dashboard/lib/exo_dashboard_web/components/result_components.ex`
  - Function components: `status_badge/1`, `step_result/1`, `progress_bar/1`, `run_summary/1`
- [x] ✓ **REFACTOR**: Clean up

### Phase 2 Validation
- [x] ✓ All infrastructure tests pass
- [x] ✓ All interface tests pass
- [x] ✓ No boundary violations (`mix compile --warnings-as-errors`)
- [x] ✓ Full test suite passes (`mix test`) -- 122 tests, 0 failures
...
- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/integration/full_flow_test.exs`
...
- [x] ✓ **GREEN**: All integration tests pass (5 tests, 0 failures)
- [x] ✓ **REFACTOR**: Clean up

### 3.2: PubSub Real-Time Integration Test

- [x] ✓ **RED**: Write test `apps/exo_dashboard/test/exo_dashboard/integration/pubsub_streaming_test.exs`
  - Tests: NdjsonWatcher reads a fixture NDJSON file and broadcasts all envelopes
  - Tests: ProcessEnvelope correctly processes a full NDJSON stream fixture (pass + fail)
...
- [x] ✓ Remove `tools/exo-bdd/allure-report/` directory (was untracked local artifact)
- [x] ✓ No allure-related dependencies found in `tools/exo-bdd/package.json`
- [x] ✓ Verify `bun test` passes (545 tests, 0 failures)

### Phase 3 Validation
- [x] ✓ Full end-to-end feature discovery works against real `.feature` files
- [x] ✓ NDJSON streaming integration works with fixture files
- [x] ✓ All tests pass (`mix test`) -- 132 tests, 0 failures for exo_dashboard
- [x] ✓ `mix compile --warnings-as-errors` clean (no boundary violations)
- [ ] ⏸ Pre-commit passes (`mix precommit`)
