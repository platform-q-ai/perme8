...
| **agents** | `AgentCreated`, `AgentUpdated`, `AgentDeleted`, `AgentAddedToWorkspace`, `AgentRemovedFromWorkspace`, `TaskCreated`, `TaskCompleted`, `TaskFailed`, `TaskCancelled`, `SessionStateChanged`, `SessionWarmingStarted`, `SessionWarmed` |
