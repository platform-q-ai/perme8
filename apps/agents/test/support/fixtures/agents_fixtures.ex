defmodule Agents.AgentsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Agents` context.
  """

  # Test fixture module - top-level boundary for test data creation
  use Boundary,
    top_level?: true,
    deps: [Agents, Agents.Test.AccountsFixtures],
    exports: []
  ...
  def user_agent_fixture(attrs \\ %{}) do
    ...
    {:ok, agent} = Agents.create_user_agent(agent_params)
    agent
  end
