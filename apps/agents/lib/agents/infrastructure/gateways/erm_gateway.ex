defmodule Agents.Infrastructure.Gateways.ErmGateway do
  @moduledoc """
  ...
  # EntityRelationshipManager is in a sibling umbrella app that cannot be
  # listed as a compile-time dependency (circular: ERM -> jarga -> agents).
  # The module is available at runtime in the umbrella.
  @compile {:no_warn_undefined, EntityRelationshipManager}

  @behaviour Agents.Application.Behaviours.ErmGatewayBehaviour
