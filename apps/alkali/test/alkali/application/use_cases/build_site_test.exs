defmodule Alkali.Application.UseCases.BuildSiteTest do
  use ExUnit.Case, async: true

  alias Alkali.Application.UseCases.BuildSite
  ...
  describe "incremental builds with layout change tracking" do
    ...
    setup do
      ...
      test_dir =
        System.tmp_dir!()
        |> Path.join(
          "alkali_test_#{System.system_time(:millisecond)}_#{:rand.uniform(1_000_000)}"
        )
