defmodule Alkali.RelativePathsTest do
  @moduledoc """
  ...
  alias Mix.Tasks.Alkali.New
  alias Mix.Tasks.Alkali.Build

  @moduletag :relative_paths
  @test_base_dir Path.join(System.tmp_dir!(), "alkali_relative_paths_test")
  ...
  describe "integration test: full relative path workflow" do
    ...
    test "post pages have one-level-up relative paths with fingerprinting", %{
      ...
      assert post_files != [], "Should have at least one post file"
    ...
    test "page files have one-level-up relative paths with fingerprinting", %{
      ...
      assert page_files != [], "Should have at least one page file"
    ...
    test "tag pages have relative paths and fingerprinting", %{output_dir: output_dir} do
      ...
      assert tag_files != [], "Should have at least one tag file"
    ...
    test "category pages have relative paths and fingerprinting", %{output_dir: output_dir} do
      ...
      assert category_files != [], "Should have at least one category file"
