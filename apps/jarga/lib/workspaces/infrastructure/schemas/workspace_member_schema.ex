defmodule Jarga.Workspaces.Infrastructure.Schemas.WorkspaceMemberSchema do
  @moduledoc """
  Ecto schema for workspace membership.

  This is the infrastructure representation that handles database persistence.
  For the pure domain entity, see Jarga.Workspaces.Domain.Entities.WorkspaceMember.
  """
