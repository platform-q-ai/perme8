defmodule Jarga.Accounts.Domain.Entities.ApiKey do
  @moduledoc """
  ...
  For database persistence, see Jarga.Accounts.Infrastructure.Schemas.ApiKeySchema.
  """
...
defimpl Inspect, for: Jarga.Accounts.Domain.Entities.ApiKey do
  ...
  def inspect(api_key, opts) do
    ...
    concat(["#Jarga.Accounts.Domain.Entities.ApiKey<", to_doc(api_key_map, opts), ">"])
  end
end
