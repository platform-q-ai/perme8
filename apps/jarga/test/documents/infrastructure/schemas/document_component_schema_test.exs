defmodule Jarga.Documents.Infrastructure.Schemas.DocumentComponentSchemaTest do
  ...
  describe "changeset/2" do
    test "valid changeset with all required fields" do
      ...
      changeset = DocumentComponentSchema.changeset(%DocumentComponentSchema{}, attrs)
