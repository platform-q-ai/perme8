defmodule Jarga.AccountsFixtures do
  ...
  Note: User and token operations use Identity.Repo since user management
  has been moved to the Identity app. API key operations still use Jarga.Repo
  as they are managed by the Jarga app.
  """
  ...
  alias Identity.Infrastructure.Schemas.{ApiKeySchema, UserSchema, UserTokenSchema}

  # Private test helper - updates user directly in database
  # Uses Identity.Repo since user data is managed by the Identity app
  ...
  def unconfirmed_user_fixture(attrs \\ %{}) do
    ...
    # Update user directly in database (test helper) - returns Jarga user
  ...
  # Uses Identity.Repo since user tokens are managed by the Identity app
