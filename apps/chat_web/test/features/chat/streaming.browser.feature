...
Feature: Chat Streaming Responses
  ...
  # Streaming requires an actual LLM response. These scenarios depend on a
  # live LLM backend. The "Thinking..." indicator appears during streaming.
  # Cancel button appears during streaming with phx-click="cancel_streaming".
