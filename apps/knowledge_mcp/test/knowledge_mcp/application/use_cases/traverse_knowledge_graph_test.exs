defmodule KnowledgeMcp.Application.UseCases.TraverseKnowledgeGraphTest do
  use ExUnit.Case, async: true

  import Mox

  alias KnowledgeMcp.Application.UseCases.TraverseKnowledgeGraph
