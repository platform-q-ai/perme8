defmodule KnowledgeMcp.Infrastructure.ErmGatewayTest do
  @moduledoc """
  ...
  Full integration tests would require the ERM app running with a graph repository.
  ...
  alias KnowledgeMcp.Infrastructure.ErmGateway
  alias KnowledgeMcp.Application.Behaviours.ErmGatewayBehaviour
