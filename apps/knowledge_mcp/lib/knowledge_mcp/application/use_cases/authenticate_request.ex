defmodule KnowledgeMcp.Application.UseCases.AuthenticateRequest do
  @moduledoc """
  ...
  @doc """
  Executes authentication for an API key token.

  ## Options

    * `:identity_module` - Module implementing IdentityBehaviour (default: Identity)

  ## Returns

    * `{:ok, %{workspace_id: String.t(), user_id: String.t()}}` on success
