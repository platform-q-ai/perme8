defmodule KnowledgeMcp.Application.UseCases.BootstrapKnowledgeSchema do
  @moduledoc """
  ...
  @doc """
  Executes schema bootstrapping for a workspace.
  ...
  ## Returns
    ...
    * `{:ok, :already_bootstrapped}` if schema already has KnowledgeEntry type
  ...
  # Build schema type definitions as plain maps that the ERM gateway
  # will convert to the appropriate structs. This avoids cross-boundary
  # references to ERM internal domain structs.
