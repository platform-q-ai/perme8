defmodule Documents.DeleteSteps do
  ...
  step "the embedded note should also be deleted", context do
    ...
    note_deleted =
      case note_id && Jarga.Repo.get(Jarga.Documents.Infrastructure.Schemas.NoteSchema, note_id) do
        nil -> true
        _ -> false
      end
    ...
    document_deleted =
      case document_id &&
             Jarga.Repo.get(Jarga.Documents.Infrastructure.Schemas.DocumentSchema, document_id) do
        nil -> true
        _ -> false
      end
