defmodule Identity.Infrastructure.Queries.TokenQueries do
  @moduledoc """
  ...
  ## Usage
      ...
      iex> {:ok, query} = TokenQueries.verify_session_token_query(token)
      iex> {user, inserted_at} = Repo.one(query)

  """

  @behaviour Identity.Application.Behaviours.QueriesBehaviour
