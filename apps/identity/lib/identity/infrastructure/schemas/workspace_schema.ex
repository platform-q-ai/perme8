defmodule Identity.Infrastructure.Schemas.WorkspaceSchema do
  @moduledoc """
  Ecto schema for workspaces.

  This is the infrastructure representation that handles database persistence.
  For the pure domain entity, see Identity.Domain.Entities.Workspace.
  """
  ...
  schema "workspaces" do
    ...
    has_many(:workspace_members, Identity.Infrastructure.Schemas.WorkspaceMemberSchema,
