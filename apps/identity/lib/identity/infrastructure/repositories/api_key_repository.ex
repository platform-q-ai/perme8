defmodule Identity.Infrastructure.Repositories.ApiKeyRepository do
  @moduledoc """
  Repository for API key data access.

  Implements `Identity.Application.Behaviours.ApiKeyRepositoryBehaviour`.
  ...
  @behaviour Identity.Application.Behaviours.ApiKeyRepositoryBehaviour

  alias Identity.Infrastructure.Schemas.ApiKeySchema
  alias Identity.Infrastructure.Queries.ApiKeyQueries
