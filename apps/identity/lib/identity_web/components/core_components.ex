defmodule IdentityWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IdentityWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IdentityWeb.Gettext, "errors", msg, opts)
    end
  end
