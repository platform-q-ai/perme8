defmodule IdentityWeb.SettingsLive do
  use IdentityWeb, :live_view

  on_mount {IdentityWeb.Plugs.UserAuth, :require_sudo_mode}
  ...
  def mount(%{"token" => token}, _session, socket) do
    socket =
      case Identity.update_user_email(current_user(socket), token) do
        {:ok, _user} ->
