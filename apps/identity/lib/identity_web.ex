defmodule IdentityWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: IdentityWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import IdentityWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias IdentityWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: IdentityWeb.Router,
        statics: IdentityWeb.static_paths()
    end
  end
