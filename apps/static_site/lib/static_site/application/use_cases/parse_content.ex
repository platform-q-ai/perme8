defmodule StaticSite.Application.UseCases.ParseContent do
  @moduledoc """
  ParseContent use case parses markdown files and creates Page entities.
  """

  alias StaticSite.Domain.Entities.Page
  alias StaticSite.Domain.Policies.{SlugPolicy, UrlPolicy, FrontmatterPolicy}
  ...
  defp default_frontmatter_parser(content) do
    alias StaticSite.Infrastructure.Parsers.FrontmatterParser
