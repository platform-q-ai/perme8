defmodule Mix.Tasks.StaticSite.New.Post do
  @shortdoc "Creates a new blog post"

  @moduledoc """
  Creates a new blog post with frontmatter template.

      mix static_site.new.post "Post Title" [site_path]
      mix static_site.new.post "Post Title" --path site_path
  ...
  ## Examples
      ...
      mix static_site.new.post "Getting Started with Elixir"
      # Creates: content/posts/2024-01-15-getting-started-with-elixir.md

      mix static_site.new.post "My Post" my_blog
      # Creates: my_blog/content/posts/2024-01-15-my-post.md

      mix static_site.new.post "My Post" --path my_blog
      # Creates: my_blog/content/posts/2024-01-15-my-post.md
  ...
  def run(args) do
    ...
    case positional_args do
      ...
      [] ->
        ...
        Mix.shell().info("Usage: mix static_site.new.post \"Post Title\" [site_path]")
        Mix.shell().info("   or: mix static_site.new.post \"Post Title\" --path site_path")
