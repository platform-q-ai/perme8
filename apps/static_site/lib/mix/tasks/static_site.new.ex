defmodule Mix.Tasks.StaticSite.New do
  ...
  - config/static_site.exs - Site configuration
  ...
  ## Examples
      ...
      mix static_site.new my_blog
      mix static_site.new my_docs --path ~/projects
  """

  use Mix.Task

  alias StaticSite.Application.UseCases.ScaffoldNewSite
  ...
  def run(args) do
    ...
    case positional_args do
      [name] ->
        ...
        case ScaffoldNewSite.execute(name, target_path: base_path) do
          {:ok, summary} ->
            ...
            Mix.shell().info("  mix static_site.build")
            Mix.shell().info("")
      ...
      [] ->
        ...
        Mix.shell().info("Usage: mix static_site.new <name>")
