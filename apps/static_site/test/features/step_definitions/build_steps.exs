defmodule StaticSite.BuildSteps do
  use Cucumber.StepDefinition
  use ExUnit.Case

  @tmp_dir System.tmp_dir!() <> "/static_site_build_test"
  ...
  step "a static site exists at {string}", %{args: [site_name]} = context do
    ...
    File.write!(Path.join(site_path, "config/static_site.exs"), config_content)
      ...
      try do
        ...
        output =
          ExUnit.CaptureIO.capture_io(fn ->
            ...
            # "mix static_site.build" -> "static_site.build"
