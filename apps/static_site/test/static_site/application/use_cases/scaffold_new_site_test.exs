defmodule StaticSite.Application.UseCases.ScaffoldNewSiteTest do
  ...
  describe "execute/2" do
    test "creates site directory structure and files" do
      ...
      assert String.contains?(config_path, "static_site.exs")
    ...
    test "generates valid site configuration" do
      ...
      file_writer = fn path, content ->
        if String.contains?(path, "static_site.exs") do
