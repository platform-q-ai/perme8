defmodule StaticSite.Application.UseCases.GenerateRssFeedTest do
  use ExUnit.Case, async: true

  alias StaticSite.Application.UseCases.GenerateRssFeed
  ...
  describe "execute/2" do
    test "generates valid RSS feed with blog posts" do
      ...
      assert xml =~ ~r/<generator>StaticSite<\/generator>/
