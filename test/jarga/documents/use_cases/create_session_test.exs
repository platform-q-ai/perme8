defmodule Jarga.Documents.UseCases.CreateSessionTest do
  @moduledoc """
  ...
  alias Jarga.Documents.UseCases.CreateSession
  alias Jarga.Repo
  ...
  describe "execute/1" do
    test "creates a session with user_id" do
      ...
      persisted = Repo.get(Jarga.Documents.ChatSession, session.id)
