defmodule Jarga.Documents.UseCases.CreateDocumentTest do
  ...
  alias Jarga.Documents.UseCases.CreateDocument
  ...
  describe "execute/2 - transaction behavior" do
    test "rolls back document creation if note creation fails" do
      ...
      # Count pages before
      documents_before = Repo.aggregate(Jarga.Documents.Document, :count)
      ...
      documents_after = Repo.aggregate(Jarga.Documents.Document, :count)
