defmodule Jarga.Pages.Domain.SlugGeneratorTest do
  ...
  describe "generate/4" do
    test "generates a simple slug from a title" do
      uniqueness_checker = fn _slug, _workspace_id, _excluding_id -> false end

      result = SlugGenerator.generate("My Page", @workspace_id, uniqueness_checker)
    ...
    test "converts spaces to hyphens" do
      ...
      result = SlugGenerator.generate("Multiple Word Page", @workspace_id, uniqueness_checker)

      assert result == "multiple-word-page"
    end
  ...
  describe "generate/4 - workspace scoping" do
    ...
    test "slugs are scoped per workspace" do
      ...
      result1 = SlugGenerator.generate("Page", "workspace-1", uniqueness_checker)
      result2 = SlugGenerator.generate("Page", "workspace-2", uniqueness_checker)
  ...
  describe "generate/4 - uniqueness" do
    ...
    test "passes generated slug to uniqueness checker" do
      ...
      SlugGenerator.generate("My Page", @workspace_id, uniqueness_checker)
